 ...
 * @section Description
 *
 * The classes in this package define the two types of diagnostic functionality
 * available in MSSPM.  The first is Parameter Variation on either side of the estimated
 * parameter values.  The second is a Retrospective Analysis using the Mohn's Rho
 * metric.
 *
 * @section License
 *
