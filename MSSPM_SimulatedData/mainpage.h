/**
 * @mainpage This project contains the MSSPM Simulated Data project
 *
 ...
 * @section Description
 *
 * This class allows the user to create simulated biomass data in order to
 * test the MSSPM estimation algorithms.
 *
 * @section License
 *
